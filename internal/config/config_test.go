...
func TestInvalidConfigurations(t *testing.T) {
	...
	tests := []struct{ name, old, new string }{
		...
		{"unsupported schema", "schema_version: 9", "schema_version: 99"},
		...
		{"renewal too early", "renewal_window_seconds: 120", "renewal_window_seconds: 301"},
		{"renewal whole freshness", "freshness_minutes: 15\n  renewal_window_seconds: 120", "freshness_minutes: 3\n  renewal_window_seconds: 180"},
		{"zero renewal window", "renewal_window_seconds: 120", "renewal_window_seconds: 0"},
		...
		{"push wildcard", "fcm.googleapis.com", "*.googleapis.com"},
		{"push IP literal", "fcm.googleapis.com", "127.0.0.1"},
		{"push contact", "https://localhost", "javascript:alert(1)"},
